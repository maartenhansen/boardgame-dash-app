...
from functions.filters import comp_filter_ranking, exe_filter_ranking # import functions for defining/creating filter components
...
### Create filter for ranking
filter_ranking = comp_filter_ranking()

### Create barchart with amount of times designers are in top 250
df_top_x_designers = get_game_amount_by_designer_top_x(engine, 250)
...
df_top_x_designers_gamenames = get_game_name_by_designer_top_x(engine, 250)
...
layout = html.Div([
    html.Div([
        ...
        html.Div([
            html.H2(children='Bordspellen in de top 250'),
            dcc.Graph(
                id='designers_in_top_250', 
...
@callback(
    ...
    Input(component_id='designers_in_top_250', component_property='hoverData')
)
